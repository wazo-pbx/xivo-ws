...
class Line(AbstractObject):
    ...
    def from_obj_dict(cls, obj_dict):
        obj = cls()
        obj._from_linefeatures(obj_dict[u'linefeatures'])
        return obj

    def _from_linefeatures(self, linefeatures):
        self.id = linefeatures[u'id']
        self.protocol = linefeatures[u'protocol']
...
class LineWebService(AbstractWebService):
    _PATH = u'/service/ipbx/json.php/restricted/pbx_settings/lines/'
    _WS_OBJECT = Line

...
class TrunkCustom(AbstractObject):
...
class TrunkCustomWebService(AbstractWebService):
    _PATH = '/service/ipbx/json.php/restricted/trunk_management/custom/'
    _OBJECT_CLASS = TrunkCustom
...
register_ws_class(TrunkCustomWebService, 'trunk_custom')
